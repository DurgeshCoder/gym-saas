        ...
        <div className="max-w-4xl mx-auto py-8 px-4 space-y-8">
            ...
            <div className="flex items-center justify-between border-b pb-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold tracking-tight">New Workout Plan</h1>
                        <p className="text-sm text-muted-foreground italic">Build a custom training schedule for your members.</p>
                    </div>
                </div>
