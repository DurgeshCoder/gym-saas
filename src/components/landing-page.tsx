      ...
      <main>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              <motion.div variants={fadeIn} className="flex justify-center">
                <Badge variant="secondary" className="rounded-full px-4 py-1.5 border-primary/20 bg-primary/5 text-primary hover:bg-primary/10 transition-colors">
              ...
              <motion.div variants={fadeIn}>
                <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight leading-[1.1] text-foreground">
                  Manage Your Gym Business <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-blue-600">Smarter</span>
                </h1>
              </motion.div>
              
              <motion.div variants={fadeIn}>
                <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                  The all-in-one multivendor platform to manage memberships, automate payments, schedule classes, and empower trainers—built to multiply your revenue.
                </p>
              </motion.div>

              <motion.div variants={fadeIn} className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                <Link href="/register">
                  <Button size="lg" className="h-14 px-8 rounded-full text-base shadow-xl shadow-primary/20 hover:scale-105 transition-transform w-full sm:w-auto">
                    Start Free Trial
                  </Button>
                </Link>
                <Link href="#demo">
                  <Button size="lg" variant="outline" className="h-14 px-8 rounded-full text-base w-full sm:w-auto border-border/50 bg-background/50 backdrop-blur-sm hover:bg-muted/50">
                    Book a Demo
                  </Button>
                </Link>
              </motion.div>
            ...
            >
              ...
              <div className="relative rounded-2xl md:rounded-3xl border border-border/50 bg-background/50 shadow-2xl overflow-hidden backdrop-blur-xl">
                <div className="flex items-center gap-2 px-4 py-3 border-b border-border/50 bg-muted/30">
                  ...
                  <div className="text-xs text-muted-foreground font-medium flex-1 text-center font-mono">dashboard.fixhubx.com</div>
                </div>
                {/* Mockup Body */}
                <div className="p-6 md:p-8 grid grid-cols-1 md:grid-cols-3 gap-6 bg-background">
                  ...
                  <div className="hidden md:flex flex-col gap-2">
                    {[1,2,3,4,5].map(i => (
                      <div key={i} className="h-10 rounded-lg bg-muted/50 w-full animate-pulse opacity-50" style={{ animationDelay: `${i * 0.1}s` }} />
                    ))}
                  </div>
                  {/* Content Mock */}
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
                      ...
                      <Card className="shadow-none border-border/50">
                        ...
                        <CardContent className="p-4 pt-0">
                          <div className="text-xs text-emerald-500 flex items-center"><ArrowRight className="w-3 h-3 mr-1 -rotate-45" /> +14.5%</div>
                        </CardContent>
                      </Card>
                      <Card className="shadow-none border-border/50">
                        <CardHeader className="p-4 pb-2">
                          <CardDescription>Monthly Revenue</CardDescription>
                          <CardTitle className="text-2xl mt-1">$45.2k</CardTitle>
                        </CardHeader>
                        <CardContent className="p-4 pt-0">
                          <div className="text-xs text-emerald-500 flex items-center"><ArrowRight className="w-3 h-3 mr-1 -rotate-45" /> +8.2%</div>
                        </CardContent>
                      </Card>
        ...
        <section className="py-12 border-y border-border/50 bg-muted/10">
          <div className="container mx-auto px-4 text-center">
            <p className="text-sm font-medium text-muted-foreground uppercase tracking-wider mb-8">Trusted by 500+ innovative gyms & studios</p>
            <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16 opacity-60 grayscale hover:grayscale-0 transition-all duration-500">
              {['FitNation', 'IronBase', 'CoreYoga', 'GoldsClub', 'AnytimeForce'].map((brand, i) => (
                <div key={i} className="flex items-center gap-2 font-bold text-xl text-foreground/80">
        ...
        <section id="features" className="py-24 relative">
          <div className="container mx-auto px-4 max-w-7xl">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-4">Everything to run your empire</h2>
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Built specifically for multi-location gyms and independent fitness businesses. Stop juggling apps and consolidate everything.
              </p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                { icon: Users, title: "Membership Management", desc: "Easily acquire, manage, and retain members with powerful engagement tools and automated check-ins." },
                { icon: ShieldCheck, title: "Multi-Gym Support", desc: "Manage multiple branches, global reporting, and unified branding from a single powerful master dashboard." },
                { icon: CreditCard, title: "Automated Payments", desc: "Stop chasing missed payments. We handle recurring billing, failed payment retries, and invoices." },
                { icon: Calendar, title: "Class Scheduling", desc: "Enable members to book trainers, reserve spots in classes, and manage their calendar on the go." },
                { icon: BarChart3, title: "Growth Analytics", desc: "Spot trends instantly. Real-time dashboards showing MRI, retention rates, and demographic insights." },
                { icon: Bell, title: "Smart Notifications", desc: "Automate SMS and email workflows for expiring plans, birthday wishes, and welcome messages." },
              ].map((feature, idx) => (
                <motion.div 
                  key={idx}
                  whileHover={{ y: -5 }}
        ...
        <section id="how-it-works" className="py-24 bg-muted/30 border-y border-border/50 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 max-w-7xl">
            <div className="flex flex-col md:flex-row gap-16 items-center">
              <div className="md:w-1/2 space-y-8">
                <h2 className="text-3xl md:text-5xl font-bold tracking-tight">From setup to scale in three steps</h2>
                <p className="text-lg text-muted-foreground">
                  Our onboarding is so simple, you'll be running your gym completely hands-free by tomorrow. 
                </p>
                
                <div className="space-y-8">
                  {[
                    { title: "Create Your Vendor Account", desc: "Sign up, configure your gym's branding, and define your locations.", step: "01" },
                    { title: "Add Plans & Staff", desc: "Create membership tiers, invite your trainers, and set up your class schedules.", step: "02" },
                    { title: "Automate & Grow", desc: "Enable auto-billing, let members self-serve via the app, and watch your revenue grow.", step: "03" },
                  ].map((step, idx) => (
        ...
        <section className="py-24 relative overflow-hidden bg-background">
           ...
           <div className="container mx-auto px-4 max-w-7xl">
             <div className="text-center mb-16 relative z-10">
               <h2 className="text-3xl md:text-5xl font-bold tracking-tight mb-4">Command your business from one place</h2>
               <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                 Our stunning dashboard turns complex data into clear, actionable insights. Say goodbye to spreadsheets.
               </p>
             </div>
               ...
               <div className="p-6 md:p-8 flex gap-6 bg-background">
                 ...
                 <div className="hidden lg:flex flex-col gap-4 w-48 shrink-0 border-r border-border/50 pr-6">
                   <div className="flex items-center gap-2 mb-4">
                     <Dumbbell className="w-5 h-5 text-primary" />
                     <span className="font-bold">FixHubX</span>
                   </div>
                   {[
                     ...
                     <div key={idx} className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm ${item.active ? 'bg-primary/10 text-primary font-medium' : 'text-muted-foreground hover:bg-muted'}`}>
                 ...
                 <div className="flex-1 space-y-6">
                   <div className="flex justify-between items-center">
                     <h3 className="text-xl font-semibold">Good morning, Michael</h3>
                   ...
                   <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                     {[
                       ...
                       <Card key={i} className="shadow-none border border-border/50 bg-muted/10">
                     ...
                     <Card className="shadow-none border border-border/50 lg:col-span-2">
                       ...
                       <CardContent className="p-5">
                         <div className="h-48 w-full flex items-end justify-between gap-2 border-b border-l border-border/50 p-2">
                           {[40, 50, 45, 60, 55, 75, 70, 90, 85, 100].map((h, idx) => (
                             <div key={idx} className="w-full bg-primary/20 rounded-t hover:bg-primary transition-colors relative group">
                               <div className="absolute bottom-0 w-full bg-primary rounded-t transition-all duration-500" style={{ height: `${h}%` }} />
                             </div>
                           ))}
                         </div>
                       </CardContent>
                     ...
                     <Card className="shadow-none border border-border/50">
                       ...
                       <CardContent className="p-5 pt-0">
                         <div className="space-y-4 pt-2">
                           {[
                             { name: "Alex Johnson", plan: "Pro Plan", time: "2m ago" },
                             { name: "Maria Garcia", plan: "Starter Plan", time: "1hr ago" },
                             { name: "James Smith", plan: "Pro Plan", time: "3hr ago" },
                             { name: "Linda Lee", plan: "Drop-in", time: "5hr ago" },
                           ].map((user, i) => (
        ...
        <section id="testimonials" className="py-24 bg-muted/20 border-t border-border/50">
          <div className="container mx-auto px-4 max-w-7xl">
            <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-center mb-16">Loved by Top Gym Owners</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                { name: "Michael Chen", role: "Owner, CoreYoga Studio", text: "FixHubX completely transformed how we operate. We replaced 4 different software tools with just this one dashboard. Revenue is up 20% due to automated payment retries." },
                { name: "Sarah Jenkins", role: "Manager, IronBase Gyms", text: "The multi-vendor support is a lifesaver. I can see the performance of all 5 of our city locations from my phone perfectly. The interface is stunning and fast." },
                { name: "David Alaba", role: "Founder, FitNation", text: "Our trainers love the scheduling app, and our members love the custom workout deliveries. Customer support has also been incredible since day one." },
              ].map((t, idx) => (
                <Card key={idx} className="bg-background shadow-sm border-border/50 hover:shadow-md transition-shadow">
                  <CardContent className="p-8">
                    <div className="flex gap-1 text-amber-400 mb-6">
                      {[1,2,3,4,5].map(i => <Star key={i} className="w-5 h-5 fill-current" />)}
                    </div>
                    <p className="text-foreground/80 mb-8 leading-relaxed">"{t.text}"</p>
        ...
        <section className="py-24 relative overflow-hidden">
           ...
           <div className="container mx-auto px-4 text-center">
             ...
             <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-10">
               Join hundreds of high-performing gyms that trust FixHubX to manage their daily operations. No credit card required.
             </p>
             <Link href="/register">
      ...
      <footer className="bg-background border-t border-border/50 pt-16 pb-8">
        <div className="container mx-auto px-4 max-w-7xl">
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-16">
            <div className="col-span-2 lg:col-span-2 space-y-4">
              ...
              <p className="text-muted-foreground max-w-sm">
                The modern operating system for gyms and fitness studios. Build, run, and scale your fitness business effortlessly.
              </p>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-border/50 text-sm text-muted-foreground">
            <p>© {new Date().getFullYear()} FixHubX. All rights reserved.</p>
