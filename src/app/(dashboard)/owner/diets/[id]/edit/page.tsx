...
export default function EditDietPage() {
    ...
    useEffect(() => {
        if (!id) return;
        fetch(`/api/diets/${id}`).then(res => res.json()).then(json => {
            if (json.data) {
    ...
    if (isLoading) return <div className="p-8 text-center text-muted-foreground">Loading diet plan...</div>;
        ...
        <div className="max-w-4xl mx-auto py-8 px-4 space-y-8">
            <div className="flex items-center justify-between border-b pb-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold tracking-tight">Edit Diet Plan</h1>
                        <p className="text-sm text-muted-foreground italic">Update the custom nutrition schedule for your members.</p>
                    </div>
                </div>
